...
console.log("Type =", typeof RestaurantData);
...
//    ]);
    ...
    return(
        <div className="body">
            ...
            <div>
                {/* <button>filtered restaurant</button> */}
             ...
             setresList(RestaurantData.filter(
                    (res) => res.info.avgRating > 4.5
                ));
            }}>
              <button className = "filter">Top Rated Restaurant</button>  
